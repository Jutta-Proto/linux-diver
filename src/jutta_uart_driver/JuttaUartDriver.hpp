...
class JuttaUartDriver {
 ...
 public:
    explicit JuttaUartDriver(std::string&& device);
    JuttaUartDriver(JuttaUartDriver&&) = delete;
    JuttaUartDriver(const JuttaUartDriver&) = delete;
    JuttaUartDriver& operator=(JuttaUartDriver&&) = delete;
    JuttaUartDriver& operator=(const JuttaUartDriver&) = delete;
    ~JuttaUartDriver();
